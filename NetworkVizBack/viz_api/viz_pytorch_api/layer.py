...
class Linear_Torch(layer.Linear):
    ...
    def __init__(self, in_features: int, out_features: int, inplace_forward: bool = False, import_linear: nn.Linear = None, name: str = "Linear_Torch", bias: bool = True, device=torch.device("cpu")):
...
class Conv2d_Torch(layer.Conv2d):
    # we can pad the linked block name to the name of layer
    def __init__(self, in_channels: int, out_channels: int, kernel_size: tuple, inplace_forward: bool = False, import_conv2d: nn.Conv2d = None, name: str="Conv2d_Torch",
...
class MaxPool2d_Torch(layer.MaxPool2d):
    # we can pad the linked block name to the name of layer
    def __init__(self, kernel_size: tuple, inplace_forward: bool = False, import_maxpool2d: nn.MaxPool2d = None, name: str = "MaxPool2d_Torch", stride: tuple=None, padding: tuple=(0, 0),
...
class BatchNorm2d_Torch(layer.BatchNorm2d):
    ...
    def __init__(self, num_features: int, inplace_forward: bool = False, import_batchnorm2d: nn.BatchNorm2d = None, name: str = "BatchNorm2d_Torch", eps: float=1e-05, momentum: float=0.1,
...
class LogSoftmax_Torch(layer.LogSoftMax):
    # we can pad the linked block name to the name of layer
    def __init__(self, dim: int, inplace_forward: bool = False, import_logsoftmax: nn.LogSoftmax = None, name: str = "LogSoftMax_Torch",
...
class ReLU_Torch(layer.ReLU):
    # we can pad the linked block name to the name of layer
    def __init__(self, import_relu: nn.ReLU=None, name: str="ReLU_Torch", device=torch.device("cpu")):
