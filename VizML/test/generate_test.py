...
monitor_Manager_0_dict = {'epochs': 10, 'model_save_path': 'test', 'device_name': 'cuda:0', 'name': 'monitor_Manager_0'}
...
input_MNIST_0_dict = {'root': '../../static/dataset/', 'max_batch_size': 64, 'shuffle': True, 'train': True, 'download': True, 'name': 'input_MNIST_0', 'device': monitor_Manager_0.device}
input_MNIST_0 = VizNode_Torch.MnistNode_Torch(input_Torch.MnistDataSetLoader_Torch, input_MNIST_0_dict)

transform_Flatten_0_dict = {'inplace_forward': True, 'name': 'transform_Flatten_0'}
transform_Flatten_0 = VizNode_Torch.TransformNode_Torch(transform_Torch.FlatTransform_Torch, transform_Flatten_0_dict)

layer_Linear_0_dict = {'in_features': 784, 'out_features': 128, 'inplace_forward': False, 'evaluate': False, 'bias': True, 'name': 'layer_Linear_0', 'device': monitor_Manager_0.device, 'import_layer': globalImportDict['layer_Linear_0']}
...
layer_LogSoftMax_0_dict = {'dim': 1, 'inplace_forward': False, 'evaluate': False, 'name': 'layer_LogSoftMax_0', 'device': monitor_Manager_0.device, 'import_layer': globalImportDict['layer_LogSoftMax_0']}
...
# -------------------- optimize initial -------------------- #
optimizer_SGD_0_track_list = [{'object':layer_Linear_0.get_linked_layer()}, {'object':layer_Linear_1.get_linked_layer()}, {'object':layer_Linear_2.get_linked_layer()}, ]
